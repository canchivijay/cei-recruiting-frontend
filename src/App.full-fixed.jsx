...
const GROQ_API_KEY = "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";
...
async function parseResume(base64, jobId, jobs) {
  ...
  if (!GROQ_API_KEY) {
  throw new Error("Groq API key missing. Add VITE_GROQ_API_KEY in .env and restart the dev server.");
}
